...
$(function () {
    ...
    function getTpl() {
        ...
        const xf_site = {
            siteInfo: [
                ...
                { name: '中转页', links: 'https://www.lixuanzer.top/', pic: 'assets/upload/zhongzhuan.jpg' },
            ]
        }
        ...
        const xf_friend = {
            friendInfo: [
                { qq: '3589564653', links: 'https://www.xdmcs.top/', name: '窗前听雨', sig: '李眩しい沢！我爱你~' },
                { qq: '3451878192', links: 'https://www.lixuanzer.top/:;', name: '李炫泽', sig: '李眩しい沢' },
            ]
        }
    ...
    yiyan()
    var isClick = true
    var xf_alert = '<div class="xf_alert"><p class="sw_txt">嗯？又被你发现了捏~李眩しい沢，我爱你哦~哥哥~</p></div>'
